...
const RegisterTherapistScreen = () => {
  ...
  const onSubmit = async () => {
    ...
    try {
      setRole('therapist');
      await register({ ...form, role: 'therapist', certificate });
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Registriere dich als Therapeut</Text>
      <Text style={styles.subtitle}>Bitte lade dein Zertifikat hoch</Text>
      ...
      <TouchableOpacity style={styles.uploadBox} onPress={() => setCertificate('uploaded.pdf')}>
        <Text style={styles.uploadLabel}>{certificate || 'Zertifikat hochladen'}</Text>
      </TouchableOpacity>
